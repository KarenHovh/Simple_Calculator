...
namespace Simple_Calculator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Hello, welcome to Karen's basic calculator!");
            Console.ReadLine();

            Console.Write("Please enter the first number in your basic equation: ");
            firstNum = Convert.ToInt32(Console.ReadLine());

          
            Console.Write("Now, please enter your second number in the basic equation: ");
